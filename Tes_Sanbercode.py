...
class TestLogin(unittest.TestCase): 
    ...
    def test_login_negative_empty_email_and_password(self): 
        # steps
        ...
        response_message = browser.find_element(By.CLASS_NAME,"error-button").text
    ...
    def test_login_negative_wrong_password(self): 
        ...
        response_message = browser.find_element(By.CSS_SELECTOR,"error-message-container error").text
    ...
    def test_checkOut_negative_empty_field(self): 
        ...
        # validasi
        response_message = browser.find_element(By.CSS_SELECTOR,"error").text
    ...
    def test_checkOut_positive(self): 
        ...
        # validasi
        response_data = browser.find_element(By.CSS_SELECTOR,"complete-header").text
        response_message = browser.find_element(By.CSS_SELECTOR,"complete-text").text
        
        self.assertIn('THANK YOU FOR YOUR ORDER', response_data)
